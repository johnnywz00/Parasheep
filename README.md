...
Unless noted, all the graphics in my programs are created by me, some programmatically and some as pixel art. The majority of sound effects that I use are from the public domain. Here I've employed the TGUI library to facilitate entering and displaying high scores (credits to Bruno Van de Velde).
...
### FILE DESCRIPTIONS
* **sfmlTguiApp:**  Implements `main()` and the abstract app
